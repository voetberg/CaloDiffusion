...
export CONFIG=$HOME/CaloDiffusion/layer_config.json

export CALODIF_COMMAND="python3 $HOME/CaloDiffusion/calodiffusion/training.py -c $CONFIG -d $TRAIN_DATA --checkpoint $CHECKPOINT_DIR --hgcal layer"

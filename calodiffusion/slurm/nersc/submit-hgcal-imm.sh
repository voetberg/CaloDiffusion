...
export CONFIG=$HOME/CaloDiffusion/imm_config.json

export CALODIF_COMMAND="timeout 2.8h python3 $HOME/CaloDiffusion/calodiffusion/training.py -c $CONFIG -d $TRAIN_DATA --checkpoint $CHECKPOINT_DIR --hgcal diffusion"
